...
INSERT INTO `mvp_db`.`items` (`title`, `description`, `image`, `category_id`, `is_available`, `user_id`, `type`) VALUES ('Projector', 'I have an Optoma DX349 available to borrow.', 'https://libraryofthings-images.s3.eu-west-2.amazonaws.com/things/89eea43c0d834a3c962b9359a8012c10-projector-2048w.png', '6', '0', '1', 'lend');
...
INSERT INTO `mvp_db`.`items` (`title`, `description`, `image`, `category_id`, `is_available`, `user_id`, `type`) VALUES ('Sewing Machine\n', 'I have a John Lewis JL 110 sewing machine available to borrow, with needle sizes 10, 12, 14 and 16.', 'https://libraryofthings-images.s3.eu-west-2.amazonaws.com/things/598cec7182554d2697e5155236d6e9f5-sewing-machine-2048w.png', '7', '1', '1', 'lend');
